...
```html
<label for="radio1" className="mdl-radio mdl-js-radio">
  <input type="radio" id="radio1" name="flash" value="on" className="mdl-radio__button">
...
```html
<label className="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="flash1">
  <input checked className="mdl-radio__button" id="flash1" name="flash" type="radio"
   value="on">
  <span className="mdl-radio__label">Always on</span>
</label>
<label className="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="flash2">
  <input className="mdl-radio__button" id="flash2" name="flash" type="radio" value="off">
  <span className="mdl-radio__label">Always off</span>
</label>
<label className="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="flash3">
  <input className="mdl-radio__button" id="flash3" name="flash" type="radio" value="auto">
...
>**Note:** Disabled versions of all the available radio button types are provided, and are invoked with the standard HTML boolean attribute `disabled`. `<input type="radio" id="radio5" name="flash" className="mdl-radio__button" disabled>`
