...
```html
<div className="mdl-grid">
  <div className="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">Content</div>
  <div className="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">goes</div>
  <div className="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">here</div>
</div>
```
...
```html
<div className="mdl-grid">
  <div className="mdl-cell mdl-cell--1-col">CS 1</div>
  <div className="mdl-cell mdl-cell--1-col">CS 1</div>
  <div className="mdl-cell mdl-cell--1-col">CS 1</div>
  <div className="mdl-cell mdl-cell--1-col">CS 1</div>
  <div className="mdl-cell mdl-cell--1-col">CS 1</div>
...
```html
<div className="mdl-grid">
  <div className="mdl-cell mdl-cell--6-col">CS 6</div>
...
```html
<div className="mdl-grid">
  <div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">CS 6 (8 on tablet)</div>
  <div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">CS 6 (8 on tablet)</div>
  <div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">CS 6 (8 on tablet)</div>
</div>
```
...
```html
<div className="mdl-grid">
  <div className="mdl-cell mdl-cell--2-col mdl-cell--4-col-phone">CS 2 (4 on phone)</div>
  <div className="mdl-cell mdl-cell--2-col mdl-cell--4-col-phone">CS 2 (4 on phone)</div>
  <div className="mdl-cell mdl-cell--2-col mdl-cell--4-col-phone">CS 2 (4 on phone)</div>
  <div className="mdl-cell mdl-cell--2-col mdl-cell--4-col-phone">CS 2 (4 on phone)</div>
</div>
