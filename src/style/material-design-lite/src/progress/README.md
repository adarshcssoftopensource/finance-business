...
```html
<div id="prog1" style="width:250px" className="mdl-js-progress"></div>
```
...
```html
<div id="progstatic" style="width:250px" className="mdl-js-progress"></div>
```

An active (animated) progress indicator.
```html
<div id="progactive" style="width:200px" className="mdl-js-progress
