...
<div className="mdl-textfield mdl-js-textfield">
  <input className="mdl-textfield__input" type="text" id="user" pattern="[A-Z,a-z, ]*">
  <label className="mdl-textfield__label" for="user">User name</label>
...
<div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
  ...
  <label className="mdl-textfield__label" for="addr1">Address line 1</label>
</div>
```
...
```html
<div className="mdl-textfield mdl-js-textfield">
  <input className="mdl-textfield__input" type="text" pattern="[0-9]*" id="phone">
  <label className="mdl-textfield__label" for="phone">Phone</label>
...
```html
<div className="mdl-textfield mdl-js-textfield">
  <textarea className="mdl-textfield__input" type="text" rows="1" id="address"></textarea>
  <label className="mdl-textfield__label" for="address">Full address</label>
</div>
```
...
```html
<div className="mdl-textfield mdl-js-textfield">
  <textarea className="mdl-textfield__input" type="text" rows="1" id="schools"></textarea>
  <label className="mdl-textfield__label" for="schools">Schools attended</label>
</div>
```
...
```html
<div className="mdl-textfield mdl-js-textfield">
  <textarea className="mdl-textfield__input" type="text" rows="3" maxrows="6"
   id="schools"></textarea>
  <label className="mdl-textfield__label" for="schools">Schools attended (max. 6)</label>
</div>
```
...
<div className="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
  <label className="mdl-button mdl-js-button mdl-button--icon" for="expando1">
    <i className="material-icons">search</i>
  </label>
  <div className="mdl-textfield__expandable-holder">
    <input className="mdl-textfield__input" type="text" id="expando1">
    <label className="mdl-textfield__label" for="expando1">Expandable text field</label>
  </div>
</div>
```
...
```html
<div className="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
  <label className="mdl-button mdl-js-button mdl-button--icon" for="search-expandable">
    <i className="material-icons">search</i>
  </label>
  <div className="mdl-textfield__expandable-holder">
    <input className="mdl-textfield__input" type="text" id="search-expandable">
    <label className="mdl-textfield__label" for="search-expandable">Search text</label>
  </div>
</div>
```
...
<div className="mdl-textfield mdl-js-textfield mdl-textfield--expandable
 mdl-textfield--floating-label">
  <label className="mdl-button mdl-js-button mdl-button--icon" for="search-expandable2">
    <i className="material-icons">search</i>
  </label>
  <div className="mdl-textfield__expandable-holder">
    <input className="mdl-textfield__input" type="text" id="search-expandable2">
    <label className="mdl-textfield__label" for="search-expandable2">
...
>**Note:** Disabled versions of each text field type are provided, and are invoked with the standard HTML boolean attribute `disabled`. `<input className="mdl-textfield mdl-js-textfield" type="text" disabled>`
