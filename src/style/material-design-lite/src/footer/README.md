...
<footer className="mdl-mega-footer">
  ...
  <div className="mdl-mega-footer__middle-section">
    <div className="mdl-mega-footer__drop-down-section">
      <h1 className="mdl-mega-footer__heading">Drop-down 1 Heading</h1>
      <ul className="mdl-mega-footer__link-list">
    ...
    <div className="mdl-mega-footer__drop-down-section">
      <h1 className="mdl-mega-footer__heading">Drop-down 2 Heading</h1>
      <ul className="mdl-mega-footer__link-list">
        <li><a href="">Link A</a></li>
        <li><a href="">Link B</a></li>
        <li><a href="">Link C</a></li>
...
<footer className="mdl-mega-footer">
  ...
  <div className="mdl-mega-footer__middle-section">
    <div className="mdl-mega-footer__drop-down-section">
      <h1 className="mdl-mega-footer__heading">Learning and Support</h1>
      <ul className="mdl-mega-footer__link-list">
    ...
    <div className="mdl-mega-footer__drop-down-section">
      <h1 className="mdl-mega-footer__heading">Just for Developers</h1>
      <ul className="mdl-mega-footer__link-list">
