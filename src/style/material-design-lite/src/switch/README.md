...
```html
<label for="switch1" className="mdl-switch mdl-js-switch">
  <input type="checkbox" id="switch1" className="mdl-switch__input">
  <span className="mdl-switch__label">Sound off/on</span>
</label>
```
...
```html
<label for="switch1" className="mdl-switch mdl-js-switch mdl-js-ripple-effect">
  <input type="checkbox" id="switch1" className="mdl-switch__input">
  <span className="mdl-switch__label">Sound off/on</span>
</label>
```
...
>**Note:** Disabled versions of all available switch types are provided, and are invoked with the standard HTML boolean attribute `disabled`. `<input type="checkbox" id="switch5" className="mdl-switch__input" disabled>`
