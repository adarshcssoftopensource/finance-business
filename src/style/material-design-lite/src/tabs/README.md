...
<div className="mdl-tabs mdl-js-tabs">
  <div className="mdl-tabs__tab-bar">
    <a href="#tab1" className="mdl-tabs__tab">Tab One</a>
    <a href="#tab2" className="mdl-tabs__tab">Tab Two</a>
    <a href="#tab3" className="mdl-tabs__tab">Tab Three</a>
  </div>
  ...
  <div className="mdl-tabs__panel" id="tab3">
    <p>Third tab's content.</p>
  </div>
</div>
```
...
<div className="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
  <div className="mdl-tabs__tab-bar">
    <a href="#about-panel" className="mdl-tabs__tab is-active">About the Beatles</a>
    <a href="#members-panel" className="mdl-tabs__tab">Members</a>
    <a href="#albums-panel" className="mdl-tabs__tab">Discography</a>
  </div>
  <div className="mdl-tabs__panel is-active" id="about-panel">
  ...
  <div className="mdl-tabs__panel" id="members-panel">
  ...
  <div className="mdl-tabs__panel" id="albums-panel">
