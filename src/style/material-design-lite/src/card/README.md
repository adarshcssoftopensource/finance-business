...
<div className="mdl-card">
  <div className="mdl-card__title">
     <h2 className="mdl-card__title-text">Auckland Sky Tower<br>Auckland, New Zealand</h2>
  </div>
  <div className="mdl-card__media">
...
<div className="mdl-card mdl-shadow--4dp">
  <div className="mdl-card__media"><img src="skytower.jpg" width="173" height="157" border="0"
