...
```html
<button id="menu1" className="mdl-button mdl-js-button mdl-button--icon">
...
```html
<ul className="mdl-menu mdl-js-menu" for="menu1">
  <li className="mdl-menu__item">Continue</li>
...
<ul className="mdl-menu mdl-js-menu" for="menu-speed">
...
<ul className="mdl-menu mdl-js-menu mdl-js-ripple-effect" for="menu-speed">
  <li className="mdl-menu__item">Fast</li>
  <li className="mdl-menu__item">Medium</li>
  <li className="mdl-menu__item">Slow</li>
</ul>
...
<ul className="mdl-menu mdl-js-menu" for="menu-speed">
  <li className="mdl-menu__item">Fast</li>
  <li className="mdl-menu__item" disabled>Medium</li>
  <li className="mdl-menu__item">Slow</li>
</ul>
```
...
>**Note:** Disabled versions of the menu options are provided, and are invoked with the standard HTML boolean attribute `disabled` or `data-mdl-disabled`. `<li className="mdl-menu__item" disabled>Medium</li>`
