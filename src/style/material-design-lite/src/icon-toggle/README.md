...
<label className="mdl-icon-toggle mdl-js-icon-toggle mdl-js-ripple-effect" for="icon-toggle-1">
  <input type="checkbox" id="icon-toggle-1" className="mdl-icon-toggle__input">
  <i className="mdl-icon-toggle__label material-icons">format_bold</i>
</label>
```
...
>**Note:** Disabled versions of all available input types are provided, and are invoked with the standard HTML boolean attribute `disabled`. `<input type="checkbox" id="icon-toggle-5" className="mdl-icon-toggle__input" disabled>`
