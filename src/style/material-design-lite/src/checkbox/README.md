...
```html
<label for="chkbox1" className="mdl-checkbox mdl-js-checkbox">
  <input type="checkbox" id="chkbox1" className="mdl-checkbox__input">
  <span className="mdl-checkbox__label">Enable AutoSave</span>
</label>
```
...
>**Note:** Disabled versions of all the available checkbox types are provided, and are invoked with the standard HTML boolean attribute `disabled`. `<input type="checkbox" id="checkbox-5" className="mdl-checkbox__input" disabled>`
