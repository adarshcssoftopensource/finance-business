...
class BillingAddress extends React.Component {
  ...
  render() {
    const { addressBilling, handleText, countryMenus, handleSet } = this.props;
    const statesOptions = this.state.statesOptions;
    return (
      <Fragment>
        <div className="py-form-field py-form-field--inline v-center">
          <Label htmlFor="addressLine1" className="py-form-field__label">
            Address line 1
          </Label>
        ...
        <div className="py-form-field py-form-field--inline">
          <Label htmlFor="country" className="py-form-field__label">
            Country
          </Label>
          <div className="py-form-field__element">
        ...
        <div className="py-form-field py-form-field--inline">
          <Label htmlFor="province" className="py-form-field__label">
            Province/State
          </Label>
          <div className="py-form-field__element">
            <div className="py-select--native">
