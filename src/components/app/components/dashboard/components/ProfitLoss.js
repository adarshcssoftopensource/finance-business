...
class ProfitLoss extends Component {
  ...
  labelFormatter: function () {
    ...
    const bg = this.userOptions.backgroundColor;
    const color = this.userOptions.textColor;
  ...
  render() {
    return (
      <div className="dh-widget net-income-widget">        
        ...
        <h6 className="widget-info">Income and expenses only (includes unpaid invoices and bills).</h6>
