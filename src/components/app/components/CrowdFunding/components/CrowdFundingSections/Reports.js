...
const Reports = props => {
  const { crowdFundingData, toggleReport, reportOpen, handleRefreshStatus, refreshReport } = props
  const report = crowdFundingData ? crowdFundingData.funding.report : null
  return (
    <div>
