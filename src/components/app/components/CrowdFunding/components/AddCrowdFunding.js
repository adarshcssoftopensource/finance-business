      ...
      <div className="peyme-box-wrapper">
        ...
        <div className="peyme-configure-box">
          ...
          <label htmlFor="userName" className="name-genarate form-control">
            <span className="url-prifix">{`${peymeBaseUrl.split("/")[2]}/give/`}</span>
            <input
              type="text"
              name="userName"
              id="userName"
          ...
          {crowdFundingSuggestionList && crowdFundingSuggestionList.length ? 
            <div className='mt-3 cursor-pointer suggestion-wrapper'>
              ...
              {crowdFundingSuggestionList.map(val => (
                <p
                  color="primary"
